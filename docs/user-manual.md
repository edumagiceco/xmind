...
│                                   │  Style │ Map │ Notes│
│     ┌──────────┐    ┌──────────┐  │                     │
│     │Main Top.2│───┐│Main Top.1│  │  토픽을 선택하면     │
│     └──────────┘   │└──────────┘  │  스타일을 편집할 수  │
│                 ┌──────────────┐  │  있습니다.           │
│                 │Central Topic │  │                     │
│                 └──────────────┘  │                     │
│     ┌──────────┐   │┌──────────┐  │                     │
│     │Main Top.4│───┘│Main Top.3│  │                     │
│     └──────────┘    └──────────┘  │                     │
│                                   │                     │
└───────────────────────────────────┴─────────────────────┘
```
...
```
┌─────────┐  ┌─────────┐  ╭─────────╮  ◇─────────◇
│ Rounded │  │  Rect   │  │ Ellipse │  │ Diamond │
└─────────┘  └─────────┘  ╰─────────╯  ◇─────────◇

 ─────────   ╭─────────╮  ╱─────────╲
  Underline  │ Capsule │  │ Parallel│
             ╰─────────╯  ╲─────────╱
```
...
```
Mind Map:             Logic Chart:         Org Chart:
    ┌─┐                  ┌─┐               ┌─┐
 ┌──┤ ├──┐            ┌──┤ ├──┐            │ │
┌┴┐ └─┘ ┌┴┐          ┌┴┐ └─┘ ┌┴┐       ┌──┼──┐
└─┘     └─┘          └─┘     └─┘      ┌┴┐┌┴┐┌┴┐
