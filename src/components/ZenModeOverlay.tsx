  ...
  return (
    <>
      ...
      {visible && (
        ...
        >
          <div className="mt-2 flex items-center gap-1 bg-white/90 backdrop-blur-sm border border-gray-200 rounded-full px-3 py-1.5 shadow-lg">
            <button
            ...
            <span className="text-xs text-gray-500 w-10 text-center select-none">{zoomPercent}%</span>
            <button
              className="p-1 rounded-full hover:bg-gray-100 text-gray-500"
              title="Zoom In"
